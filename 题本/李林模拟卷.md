...
> \sum_{n=1}^\infty\left(\frac1n-\sin\frac1n\right)^a
> $$
> 当 $n\to\infty$ 时，可以将其看作是一个无穷小：$t-\sin t$，而根据我们十分熟悉的等价无穷小链，我们知道 $t-\sin t\sim\frac16x^3$，因此，这里的无穷级数的敛散性与以下无穷级数是一致的：
> $$
> \sum_{n=1}^\infty\frac1{x^{3a}}
> $$
> 显然，若它要收敛，则 $3a>1$，也就是 $a>\frac13 $，因此 $\frac13<a\le\frac12$
